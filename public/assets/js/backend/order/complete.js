 ...
 Fast.config.openArea = ['100%', '100%'];
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'order/complete/index' + location.search,
                    add_url: 'order/complete/add',
                    // edit_url: 'order/complete/edit',
                    del_url: 'order/complete/del',
                    multi_url: 'order/complete/multi',
                    import_url: 'order/complete/import',
                    table: 'order',
                }
            });
