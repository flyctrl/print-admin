<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/www/wwwroot/print/public/../application/admin/view/order/order/index.html";i:1713164010;s:61:"/www/wwwroot/print/application/admin/view/layout/default.html";i:1689043530;s:58:"/www/wwwroot/print/application/admin/view/common/meta.html";i:1689043530;s:60:"/www/wwwroot/print/application/admin/view/common/script.html";i:1689043530;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<!--                        <a href="javascript:;" class="btn btn-danger btn-del btn-disabled disabled <?php echo $auth->check('order/order/del')?'':'hide'; ?>" title="<?php echo __('Delete'); ?>" ><i class="fa fa-trash"></i> <?php echo __('Delete'); ?></a>-->
                        ...
                        <a href="order/prints/import" class="btn btn-danger btn-dialog <?php echo $auth->check('order/prints/import')?'':'hide'; ?>" title="<?php echo __('Import'); ?>" ><i class="fa fa-upload"></i> <?php echo __('Import'); ?></a>
                    </div>
