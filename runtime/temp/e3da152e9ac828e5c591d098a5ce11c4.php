<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:67:"/www/wwwroot/print/public/../application/admin/view/signs/edit.html";i:1742299914;s:61:"/www/wwwroot/print/application/admin/view/layout/default.html";i:1689043530;s:58:"/www/wwwroot/print/application/admin/view/common/meta.html";i:1689043530;s:60:"/www/wwwroot/print/application/admin/view/common/script.html";i:1689043530;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-sign_image" class="form-control" size="50" name="row[sign_image]" type="text" value="<?php echo htmlentities($row['sign_image']); ?>">
