<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:74:"/www/wwwroot/print/public/../application/admin/view/order/refund/edit.html";i:1707099753;s:61:"/www/wwwroot/print/application/admin/view/layout/default.html";i:1689043530;s:58:"/www/wwwroot/print/application/admin/view/common/meta.html";i:1689043530;s:60:"/www/wwwroot/print/application/admin/view/common/script.html";i:1689043530;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('File_num'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-file_num" class="form-control" name="row[file_num]" type="number" value="<?php echo htmlentities($row['file_num']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Order_price'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-order_price" class="form-control" step="0.01" name="row[order_price]" type="number" value="<?php echo htmlentities($row['order_price']); ?>">
        </div>
    </div>
    <!--<div class="form-group">-->
    <!--    <label class="control-label col-xs-12 col-sm-2"><?php echo __('User_ticket_id'); ?>:</label>-->
    <!--    <div class="col-xs-12 col-sm-8">-->
    <!--        <input id="c-user_ticket_id" data-rule="required" data-source="user/ticket/index" class="form-control selectpage" name="row[user_ticket_id]" type="text" value="<?php echo htmlentities($row['user_ticket_id']); ?>">-->
    <!--    </div>-->
    <!--</div>-->
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Ticket_price'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-ticket_price" class="form-control" step="0.01" name="row[ticket_price]" type="number" value="<?php echo htmlentities($row['ticket_price']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-total_price" class="form-control" step="0.01" name="row[total_price]" type="number" value="<?php echo htmlentities($row['total_price']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Pay_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-pay_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[pay_time]" type="text" value="<?php echo $row['pay_time']?datetime($row['pay_time']):''; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Freight'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-freight" class="form-control" step="0.01" name="row[freight]" type="number" value="<?php echo htmlentities($row['freight']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Express_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-express_id" data-rule="required" data-source="express/index" class="form-control selectpage" name="row[express_id]" type="text" value="<?php echo htmlentities($row['express_id']); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Express_num'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-express_num" class="form-control" name="row[express_num]" type="text" value="<?php echo htmlentities($row['express_num']); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Invoice'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
                        
            <select  id="c-invoice" class="form-control selectpicker" name="row[invoice]">
                <?php if(is_array($invoiceList) || $invoiceList instanceof \think\Collection || $invoiceList instanceof \think\Paginator): if( count($invoiceList)==0 ) : echo "" ;else: foreach($invoiceList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['invoice'])?$row['invoice']:explode(',',$row['invoice']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <!--<div class="form-group">-->
    <!--    <label class="control-label col-xs-12 col-sm-2"><?php echo __('Look_up_id'); ?>:</label>-->
    <!--    <div class="col-xs-12 col-sm-8">-->
    <!--        <input id="c-look_up_id" data-rule="required" data-source="look/up/index" class="form-control selectpage" name="row[look_up_id]" type="text" value="<?php echo htmlentities($row['look_up_id']); ?>">-->
    <!--    </div>-->
    <!--</div>-->
    <!--<div class="form-group">-->
    <!--    <label class="control-label col-xs-12 col-sm-2"><?php echo __('Invoice_time'); ?>:</label>-->
    <!--    <div class="col-xs-12 col-sm-8">-->
    <!--        <input id="c-invoice_time" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[invoice_time]" type="text" value="<?php echo $row['invoice_time']?datetime($row['invoice_time']):''; ?>">-->
    <!--    </div>-->
    <!--</div>-->
    <div class="form-group">
